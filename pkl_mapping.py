...
# 指定文件夹路径
dir_path = '/media/user/2634e654-9e1a-49b2-a9d8-fb746a23d9fd/celebID/test_gt/'
...
file_names_without_ext = [os.path.splitext(file)[0] for file in all_files if file.endswith('.jpg')]
